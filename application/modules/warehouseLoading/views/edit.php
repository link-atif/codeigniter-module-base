...
<h3>Edit Warehouse Container loading</h3>
<br />          
<br />  
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <label>Date:</label>
                        <input type="date" class="form-control" id="date" name="date" value="<?=$warehouseloading['date']?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="ksl-slip-no" name="ksl_slip_number" value="<?=$warehouseloading['ksl_slip_number']?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="Quantity" name="quantity" value="<?=$warehouseloading['quantity']?>">
                    </div>
                    <div class="form-group">
                        <label>Weight:</label>
                        <input type="number" class="form-control" id="weight" name="weight" value="<?=$warehouseloading['weight']?>">
                    </div>
                    <div class="form-group">
                        <label>Rate:</label>
                        <input type="number" class="form-control" id="rate" name="rate"value="<?=$warehouseloading['rate']?>">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="days" name="days" value="<?=$warehouseloading['days']?>">
                    </div>
                    <div class="form-group">
                        <label class="" >Dispatch:</label>
                        <input type="text" class="form-control" id="dispatch" name="dispatch" value="<?=$warehouseloading['dispatch']?>">
                    </div>
